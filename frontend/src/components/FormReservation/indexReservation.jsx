...
export default function FormReservation() {
  ...
  const [manualDirection, setmanualDirection] = useState(undefined);
  ...
  useEffect(() => {
    const reultMountReserva = mountTotal
  ...
  const handleVehicleSelected = (
    ...
    setArrayDetalleReserva((prev) => {
      ...
      setFieldValue("subTotal", totalInventario);
      let montoPorReserva =
        (totalInventario * politicaPagoReserva.porcentajeAPagar) / 100;
      setFieldValue("monto_por_la_reserva", montoPorReserva);

      setSubTotal(totalInventario - montoPorReserva);
      setFieldValue("total", totalInventario - montoPorReserva);
  ...
  useEffect(() => {
    ...
    axios.get("http://localhost:3000/api/configPuntos").then((response) => {
      setConfigData(response.data[0] ?? 0);
    });
  ...
  const handleSubmit = (values) => {
    ...
    try {
      axios
        .post("http://localhost:3000/api/reserva", values)
        .then((response) => {
          console.log(response);
          Swal.fire({
      ...
      Swal.fire({
        title: "RentEasy Alert",
        text: "Hubo un error al registrar la reserva",
        icon: "info",
      });
  ...
  //   if(monto > 0){
  //     console.log(monto)
  //      resultTotal = monto * politicaPagoReserva.porcentajeAPagar / 100;
  //      setFieldValue("monto_por_la_reserva", resultTotal || 0)
  //   } else{
  //     setFieldValue("monto_por_la_reserva", resultTotal || 0)
  //   }
  // }, [mountTotal])
      ...
      >
        {({ handleChange, setValues, setFieldValue, values }) => (
          <Form>
              ...
              <div className="field">
                ...
                <div className="control">
                  <Field
                    ...
                    // value={mountTotal ? mountTotal * politicaPagoReserva.porcentajeAPagar / 100 : 0}
                  ></Field>
                  <ErrorMessage
                    name="subTotal"
                    component="p"
            ...
            <div className="group-medio">
              <div className="field">
                <label className="label">Monto Reserva</label>
                <div className="control">
                  <Field
                    className="input"
                    type="number"
                    name="monto_por_la_reserva"
                    placeholder="Monto de la reserva"
                    value={values.monto_por_la_reserva}
                    // onChange={((e)=>{
                    //   setFieldValue("monto_por_la_reserva",e.target.value)
                    //   console.log(e.target.value)
                    //   values.monto_por_la_reserva
                    // })}
                  />
                  <ErrorMessage
                    name="monto_por_la_reserva"
              ...
              <div className="field">
                <label className="label">Origen de la reserva</label>
                <div className="control">
                  <Field className="select" as="select" name="OrigenReserva">
              ...
              <div className="field">
                ...
                <div className="control">
                  <Field
                    ...
                    value={isEditable ? values.puntos_canjeados || 0 : 0}
                    placeholder={
                      isEditable
                    ...
                    onChange={(e) => {
                      if (isEditable) {
                        ...
                        setFieldValue("puntos_canjeados", valor);
            ...
            <div className="field-is-grouped">
              <div className="control">
                <button
                  ...
                  type={values.monto_por_la_reserva > 0 ? "button" : "submit"}
                  onClick={() => {
                    if (
                      values.monto_por_la_reserva > 0 &&
                      arrayDetalleReserva
                    ) {
                      setModalIsOpen(true);
                    } else {
            ...
            <Modal
              ...
              onRequestClose={() => {
                ...
                handleSubmit(); // Llama al handleSubmit
              }}
                ...
                <form className="modalForm">
                  ...
                  <div className="formGroup">
                    ...
                    <input
                      type="number"
                      id="amount"
                      value={values.monto_por_la_reserva || 0}
